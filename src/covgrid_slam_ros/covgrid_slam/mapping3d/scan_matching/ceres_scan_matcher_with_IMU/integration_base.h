...
class IntegrationBase
{
  public:
                            ...
                            Eigen::Vector3d &result_linearized_ba, Eigen::Vector3d &result_linearized_bg, bool update_jacobian)
    {
        ...
        /// use Jacobian to linear predict
        if(update_jacobian)
        {
                                          ...
                                          const Eigen::Vector3d &Pj, const Eigen::Quaterniond &Qj, const Eigen::Vector3d &Vj, const Eigen::Vector3d &Baj, const Eigen::Vector3d &Bgj)
    {
        ...
        ///　residuals = measurement - predict. Here corrected***** is prediction part
    ...
    double dt;
    Eigen::Vector3d acc_0, gyr_0; //imu measurements of current time.
    Eigen::Vector3d acc_1, gyr_1; // next time. because forward mid-point integration
    ...
    Eigen::Matrix<double, 18, 18> noise; // noise cov Matrix

...
#include "covgrid_slam/mapping/scan_matching/proto/fast_correlative_scan_matcher_options.pb.h"

#include "covgrid_slam/mapping/probability_grid.h"
#include "covgrid_slam/mapping/scan_matching/correlative_scan_matcher.h"
...
class FastCorrelativeScanMatcher {
 public:
  ...
  // with the result.
  bool Match(const ivcommon::transform::Rigid2d& initial_pose_estimate,
             const sensor::PointCloud& point_cloud, float min_score,
             float* score, ivcommon::transform::Rigid2d* pose_estimate) const;

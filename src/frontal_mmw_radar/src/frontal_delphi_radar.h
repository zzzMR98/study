...
#ifdef TOYOTA
//const definition
const int FRONTAL_RADAR_PORT = 8400;
const int FRONTAL_RADAR_LISTEN_PORT = 8500; //local listen port
#endif

#ifdef HUACHEN
//const definition
const int FRONTAL_RADAR_PORT = 14021;
const int FRONTAL_RADAR_LISTEN_PORT = 14010; //local listen port
#endif
...
private:
  ...
  sockaddr_in remaddr_; //remote(远程) address

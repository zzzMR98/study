...
double UTMconv::DegToRad(double deg)
{
...
*
*/
double UTMconv::RadToDeg(double rad)
{
...
*
*/
double UTMconv::ArcLengthOfMeridian(double phi)
{
...
*
*/
double UTMconv::UTMCentralMeridian(int zone)
{
...
*
*/
double UTMconv::FootpointLatitude(double y)
{
...
*
*/
void UTMconv::MapLatLonToXY(double phi, double lambda, double lambda0, UTMCoor &xy)
{
...
*
*/
void UTMconv::MapXYToLatLon(double x, double y, double lambda0, WGS84Corr &philambda)
{
...
*
*/
void UTMconv::LatLonToUTMXY(double lat, double lon, int zone, UTMCoor &xy)
{
...
*
*/
void UTMconv::UTMXYToLatLon(double x, double y, int zone, bool southhemi, WGS84Corr &latlon)
{
	double cmeridian;
